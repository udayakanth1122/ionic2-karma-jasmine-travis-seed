...
openssl aes-256-cbc -K $encrypted_c4563c0abb0a_key -iv $encrypted_c4563c0abb0a_iv -in .travis/travis_deploy_key.pub.enc -out .travis/travis_deploy_key -pass $PASSPHRASE -d
eval "$(ssh-agent -s)"
